...
% DEFINE_TIMEDOMAIN_DATASET MATLAB code for define_TimeDomain_dataset.fig
...
%
%      DEFINE_TIMEDOMAIN_DATASET('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DEFINE_TIMEDOMAIN_DATASET.M with the given input arguments.
%
%      DEFINE_TIMEDOMAIN_DATASET('Property','Value',...) creates a new DEFINE_TIMEDOMAIN_DATASET or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before define_TimeDomain_dataset_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to define_TimeDomain_dataset_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 09-Aug-2018 15:40:41
...
% varargin   command line arguments to define_TimeDomain_dataset (see VARARGIN)
